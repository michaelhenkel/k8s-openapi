...
impl crate::DeepMerge for GracefulRestartParametersType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.bgp_helper_enable, other.bgp_helper_enable);
        crate::DeepMerge::merge_from(&mut self.enable, other.enable);
        crate::DeepMerge::merge_from(&mut self.end_of_rib_timeout, other.end_of_rib_timeout);
        crate::DeepMerge::merge_from(&mut self.long_lived_restart_time, other.long_lived_restart_time);
        crate::DeepMerge::merge_from(&mut self.restart_time, other.restart_time);
        crate::DeepMerge::merge_from(&mut self.xmpp_helper_enable, other.xmpp_helper_enable);
    }
}

impl<'de> crate::serde::Deserialize<'de> for GracefulRestartParametersType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_bgp_helper_enable => value_bgp_helper_enable = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_enable => value_enable = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_end_of_rib_timeout => value_end_of_rib_timeout = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_long_lived_restart_time => value_long_lived_restart_time = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_restart_time => value_restart_time = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_xmpp_helper_enable => value_xmpp_helper_enable = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for GracefulRestartParametersType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.bgp_helper_enable {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "bgpHelperEnable", value)?;
        }
        ...
        if let Some(value) = &self.end_of_rib_timeout {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "endOfRibTimeout", value)?;
        }
        if let Some(value) = &self.long_lived_restart_time {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "longLivedRestartTime", value)?;
        }
        if let Some(value) = &self.restart_time {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "restartTime", value)?;
        }
        if let Some(value) = &self.xmpp_helper_enable {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "xmppHelperEnable", value)?;
        }
