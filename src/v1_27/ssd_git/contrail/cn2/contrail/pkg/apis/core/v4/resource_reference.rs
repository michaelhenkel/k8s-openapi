// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.ResourceReference

/// ResourceReference is an ObjectReference to a Contrail resource that contains the ContrailFqName of the resource being referenced.
...
impl crate::DeepMerge for ResourceReference {
...
impl<'de> crate::serde::Deserialize<'de> for ResourceReference {
...
impl crate::serde::Serialize for ResourceReference {
...
impl crate::schemars::JsonSchema for ResourceReference {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.ResourceReference".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ResourceReference is an ObjectReference to a Contrail resource that contains the ContrailFqName of the resource being referenced.".to_owned()),
                ..Default::default()
            })),
