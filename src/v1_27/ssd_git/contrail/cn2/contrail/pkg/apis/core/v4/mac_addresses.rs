...
impl crate::DeepMerge for MACAddresses {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.mac_address, other.mac_address);
    }
}

impl<'de> crate::serde::Deserialize<'de> for MACAddresses {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_mac_address => value_mac_address = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for MACAddresses {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.mac_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "macAddress", value)?;
        }
