// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.FirewallRuleReference
...
pub struct FirewallRuleReference {
    ...
    pub attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::FirewallPolicyAttribute>,
...
impl crate::DeepMerge for FirewallRuleReference {
...
impl<'de> crate::serde::Deserialize<'de> for FirewallRuleReference {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("FirewallRuleReference")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_api_version: Option<String> = None;
                let mut value_attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::FirewallPolicyAttribute> = None;
...
impl crate::serde::Serialize for FirewallRuleReference {
...
impl crate::schemars::JsonSchema for FirewallRuleReference {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.FirewallRuleReference".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("FirewallRuleReference is a ResourceReference to a FirewallRule with a FirewallPolicyAttribute containing the Sequence Number.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "attributes".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::FirewallPolicyAttribute>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Attribute defines the Sequence Number of a FirewallRule in [a given|the] FirewallPolicy.".to_owned()),
                                ..Default::default()
                            }));
