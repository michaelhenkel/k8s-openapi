...
impl crate::DeepMerge for GlobalSystemConfigSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.default_enable_snat, other.default_enable_snat);
        crate::DeepMerge::merge_from(&mut self.enable4bytes_as, other.enable4bytes_as);
        crate::DeepMerge::merge_from(&mut self.fast_convergence_parameters, other.fast_convergence_parameters);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.graceful_restart_parameters, other.graceful_restart_parameters);
        crate::DeepMerge::merge_from(&mut self.ibgp_auto_mesh, other.ibgp_auto_mesh);
    }
}

impl<'de> crate::serde::Deserialize<'de> for GlobalSystemConfigSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_default_enable_snat => value_default_enable_snat = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_enable4bytes_as => value_enable4bytes_as = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fast_convergence_parameters => value_fast_convergence_parameters = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_graceful_restart_parameters => value_graceful_restart_parameters = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ibgp_auto_mesh => value_ibgp_auto_mesh = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for GlobalSystemConfigSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.default_enable_snat {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "defaultEnableSNAT", value)?;
        }
        if let Some(value) = &self.enable4bytes_as {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "enable4bytesAS", value)?;
        }
        if let Some(value) = &self.fast_convergence_parameters {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "fastConvergenceParameters", value)?;
        }
        ...
        if let Some(value) = &self.graceful_restart_parameters {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "gracefulRestartParameters", value)?;
        }
        if let Some(value) = &self.ibgp_auto_mesh {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ibgpAutoMesh", value)?;
        }
