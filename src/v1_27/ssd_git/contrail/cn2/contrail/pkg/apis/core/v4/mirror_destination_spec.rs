...
impl crate::DeepMerge for MirrorDestinationSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.analyzer_ip, other.analyzer_ip);
        crate::DeepMerge::merge_from(&mut self.external_analyzer, other.external_analyzer);
        ...
        crate::DeepMerge::merge_from(&mut self.next_hop_mode, other.next_hop_mode);
        crate::DeepMerge::merge_from(&mut self.nic_assisted_mirroring, other.nic_assisted_mirroring);
        crate::DeepMerge::merge_from(&mut self.nic_assisted_vlan_id, other.nic_assisted_vlan_id);
        crate::DeepMerge::merge_from(&mut self.static_next_hop_header, other.static_next_hop_header);
        crate::DeepMerge::merge_from(&mut self.traffic_direction, other.traffic_direction);
        crate::DeepMerge::merge_from(&mut self.udp_port, other.udp_port);
    }
}

impl<'de> crate::serde::Deserialize<'de> for MirrorDestinationSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_analyzer_ip => value_analyzer_ip = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_external_analyzer => value_external_analyzer = crate::serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_next_hop_mode => value_next_hop_mode = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_nic_assisted_mirroring => value_nic_assisted_mirroring = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_nic_assisted_vlan_id => value_nic_assisted_vlan_id = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_static_next_hop_header => value_static_next_hop_header = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_traffic_direction => value_traffic_direction = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for MirrorDestinationSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.analyzer_ip {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "analyzerIP", value)?;
        }
        if let Some(value) = &self.external_analyzer {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "externalAnalyzer", value)?;
        }
        ...
        if let Some(value) = &self.juniper_header {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "juniperHeader", value)?;
        }
        if let Some(value) = &self.next_hop_mode {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nextHopMode", value)?;
        }
        if let Some(value) = &self.nic_assisted_mirroring {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nicAssistedMirroring", value)?;
        }
        if let Some(value) = &self.nic_assisted_vlan_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nicAssistedVlanID", value)?;
        }
        if let Some(value) = &self.static_next_hop_header {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "staticNextHopHeader", value)?;
        }
        if let Some(value) = &self.traffic_direction {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "trafficDirection", value)?;
        }
