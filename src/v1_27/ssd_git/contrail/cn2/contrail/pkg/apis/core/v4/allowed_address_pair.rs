...
impl crate::DeepMerge for AllowedAddressPair {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.address_mode, other.address_mode);
        crate::DeepMerge::merge_from(&mut self.ip, other.ip);
        crate::DeepMerge::merge_from(&mut self.mac, other.mac);
    }
}

impl<'de> crate::serde::Deserialize<'de> for AllowedAddressPair {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_address_mode => value_address_mode = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ip => value_ip = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_mac => value_mac = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for AllowedAddressPair {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.address_mode {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "addressMode", value)?;
        }
        if let Some(value) = &self.ip {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ip", value)?;
        }
        if let Some(value) = &self.mac {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "mac", value)?;
        }
