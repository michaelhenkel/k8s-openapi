...
impl crate::DeepMerge for AddressGroupSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.address_group_prefixes, other.address_group_prefixes);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
    }
}

impl<'de> crate::serde::Deserialize<'de> for AddressGroupSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_address_group_prefixes => value_address_group_prefixes = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for AddressGroupSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.address_group_prefixes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "addressGroupPrefixes", value)?;
        }
