...
impl crate::DeepMerge for ServiceHealthCheckProperties {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.delay, other.delay);
        crate::DeepMerge::merge_from(&mut self.delay_usecs, other.delay_usecs);
        crate::DeepMerge::merge_from(&mut self.enabled, other.enabled);
        crate::DeepMerge::merge_from(&mut self.expected_codes, other.expected_codes);
        crate::DeepMerge::merge_from(&mut self.health_check_type, other.health_check_type);
        crate::DeepMerge::merge_from(&mut self.http_method, other.http_method);
        crate::DeepMerge::merge_from(&mut self.max_retries, other.max_retries);
        crate::DeepMerge::merge_from(&mut self.monitor_type, other.monitor_type);
        crate::DeepMerge::merge_from(&mut self.target_ip_all, other.target_ip_all);
        crate::DeepMerge::merge_from(&mut self.target_ip_list, other.target_ip_list);
        crate::DeepMerge::merge_from(&mut self.timeout, other.timeout);
        crate::DeepMerge::merge_from(&mut self.timeout_usecs, other.timeout_usecs);
        crate::DeepMerge::merge_from(&mut self.url_path, other.url_path);
    }
}

impl<'de> crate::serde::Deserialize<'de> for ServiceHealthCheckProperties {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_delay => value_delay = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_delay_usecs => value_delay_usecs = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_enabled => value_enabled = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_expected_codes => value_expected_codes = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_health_check_type => value_health_check_type = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_http_method => value_http_method = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_max_retries => value_max_retries = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_monitor_type => value_monitor_type = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_target_ip_all => value_target_ip_all = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_target_ip_list => value_target_ip_list = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_timeout => value_timeout = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_timeout_usecs => value_timeout_usecs = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_url_path => value_url_path = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for ServiceHealthCheckProperties {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "delay", &self.delay)?;
        if let Some(value) = &self.delay_usecs {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "delayUsecs", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "enabled", &self.enabled)?;
        if let Some(value) = &self.expected_codes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "expectedCodes", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "healthCheckType", &self.health_check_type)?;
        if let Some(value) = &self.http_method {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "httpMethod", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "maxRetries", &self.max_retries)?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "monitorType", &self.monitor_type)?;
        if let Some(value) = &self.target_ip_all {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "targetIpAll", value)?;
        }
        if let Some(value) = &self.target_ip_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "targetIpList", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "timeout", &self.timeout)?;
        if let Some(value) = &self.timeout_usecs {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "timeoutUsecs", value)?;
        }
        if let Some(value) = &self.url_path {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "urlPath", value)?;
        }
