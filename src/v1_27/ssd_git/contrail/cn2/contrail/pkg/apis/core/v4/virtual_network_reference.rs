// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.VirtualNetworkReference

/// VirtualNetworkReference contains a VirtualNetwork reference and an Attributes instance defining a virtual network router.
...
pub struct VirtualNetworkReference {
    ...
    pub attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::KeyValuePair>,
...
impl crate::DeepMerge for VirtualNetworkReference {
...
impl<'de> crate::serde::Deserialize<'de> for VirtualNetworkReference {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("VirtualNetworkReference")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_api_version: Option<String> = None;
                let mut value_attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::KeyValuePair> = None;
...
impl crate::serde::Serialize for VirtualNetworkReference {
...
impl crate::schemars::JsonSchema for VirtualNetworkReference {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.VirtualNetworkReference".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("VirtualNetworkReference contains a VirtualNetwork reference and an Attributes instance defining a virtual network router.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "attributes".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::KeyValuePair>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Attributes contains a different attributes of VirtualNetworkReference".to_owned()),
                                ..Default::default()
                            }));
