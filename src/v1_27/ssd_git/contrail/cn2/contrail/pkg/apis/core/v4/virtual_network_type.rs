...
impl crate::DeepMerge for VirtualNetworkType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.forwarding_mode, other.forwarding_mode);
        crate::DeepMerge::merge_from(&mut self.rpf, other.rpf);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualNetworkType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_forwarding_mode => value_forwarding_mode = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_rpf => value_rpf = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualNetworkType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.forwarding_mode {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "forwardingMode", value)?;
        }
        if let Some(value) = &self.rpf {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "rpf", value)?;
        }
