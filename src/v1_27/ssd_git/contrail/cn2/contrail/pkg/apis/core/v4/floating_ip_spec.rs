...
impl crate::DeepMerge for FloatingIPSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.floating_ip_address, other.floating_ip_address);
        crate::DeepMerge::merge_from(&mut self.floating_ip_port_mappings, other.floating_ip_port_mappings);
        crate::DeepMerge::merge_from(&mut self.floating_ip_port_mappings_enable, other.floating_ip_port_mappings_enable);
        crate::DeepMerge::merge_from(&mut self.floating_ip_traffic_direction, other.floating_ip_traffic_direction);
...
impl<'de> crate::serde::Deserialize<'de> for FloatingIPSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_floating_ip_address => value_floating_ip_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_floating_ip_port_mappings => value_floating_ip_port_mappings = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_floating_ip_port_mappings_enable => value_floating_ip_port_mappings_enable = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_floating_ip_traffic_direction => value_floating_ip_traffic_direction = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FloatingIPSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.floating_ip_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "floatingIPAddress", value)?;
        }
        if let Some(value) = &self.floating_ip_port_mappings {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "floatingIPPortMappings", value)?;
        }
        if let Some(value) = &self.floating_ip_port_mappings_enable {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "floatingIPPortMappingsEnable", value)?;
        }
        if let Some(value) = &self.floating_ip_traffic_direction {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "floatingIPTrafficDirection", value)?;
        }
