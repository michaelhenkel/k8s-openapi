...
impl crate::DeepMerge for TagStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.tag_id, other.tag_id);
    }
}

impl<'de> crate::serde::Deserialize<'de> for TagStatus {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_tag_id => value_tag_id = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for TagStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.tag_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagId", value)?;
        }
