...
impl crate::DeepMerge for FirewallServiceGroupType {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.firewall_service, other.firewall_service);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallServiceGroupType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_firewall_service => value_firewall_service = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallServiceGroupType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.firewall_service {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "FirewallService", value)?;
        }
