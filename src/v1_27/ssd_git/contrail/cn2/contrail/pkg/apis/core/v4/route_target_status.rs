// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.RouteTargetStatus
...
impl crate::DeepMerge for RouteTargetStatus {
...
impl<'de> crate::serde::Deserialize<'de> for RouteTargetStatus {
...
impl crate::serde::Serialize for RouteTargetStatus {
...
impl crate::schemars::JsonSchema for RouteTargetStatus {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.RouteTargetStatus".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("RouteTargetStatus defines the observed state of a RouteTarget.".to_owned()),
                ..Default::default()
            })),
