...
impl crate::DeepMerge for RouteType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.community_attributes, other.community_attributes);
        crate::DeepMerge::merge_from(&mut self.next_hop, other.next_hop);
        crate::DeepMerge::merge_from(&mut self.next_hop_type, other.next_hop_type);
        crate::DeepMerge::merge_from(&mut self.prefix, other.prefix);
    }
}

impl<'de> crate::serde::Deserialize<'de> for RouteType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_community_attributes => value_community_attributes = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_next_hop => value_next_hop = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_next_hop_type => value_next_hop_type = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for RouteType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.community_attributes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "communityAttributes", value)?;
        }
        if let Some(value) = &self.next_hop {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nextHop", value)?;
        }
        if let Some(value) = &self.next_hop_type {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nextHopType", value)?;
        }
