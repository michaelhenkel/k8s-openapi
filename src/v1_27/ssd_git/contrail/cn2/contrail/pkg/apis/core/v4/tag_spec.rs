...
impl crate::DeepMerge for TagSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.tag_type_name, other.tag_type_name);
        crate::DeepMerge::merge_from(&mut self.tag_type_reference, other.tag_type_reference);
        crate::DeepMerge::merge_from(&mut self.tag_value, other.tag_value);
    }
}

impl<'de> crate::serde::Deserialize<'de> for TagSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_tag_type_name => value_tag_type_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_tag_type_reference => value_tag_type_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_tag_value => value_tag_value = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for TagSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.tag_type_name {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagTypeName", value)?;
        }
        if let Some(value) = &self.tag_type_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagTypeReference", value)?;
        }
        if let Some(value) = &self.tag_value {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagValue", value)?;
        }
