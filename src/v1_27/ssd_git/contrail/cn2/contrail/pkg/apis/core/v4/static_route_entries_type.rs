...
impl crate::DeepMerge for StaticRouteEntriesType {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.route, other.route);
    }
}

impl<'de> crate::serde::Deserialize<'de> for StaticRouteEntriesType {
...
impl crate::serde::Serialize for StaticRouteEntriesType {
