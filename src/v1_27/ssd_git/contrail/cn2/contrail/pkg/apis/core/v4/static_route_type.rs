...
impl crate::DeepMerge for StaticRouteType {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.community, other.community);
        crate::DeepMerge::merge_from(&mut self.next_hop, other.next_hop);
        crate::DeepMerge::merge_from(&mut self.prefix, other.prefix);
        crate::merge_strategies::list::atomic(&mut self.route_target, other.route_target);
    }
}

impl<'de> crate::serde::Deserialize<'de> for StaticRouteType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_community => value_community = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for StaticRouteType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.community {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "community", value)?;
        }
