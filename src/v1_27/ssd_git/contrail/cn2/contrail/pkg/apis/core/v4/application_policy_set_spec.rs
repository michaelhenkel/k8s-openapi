...
impl crate::DeepMerge for ApplicationPolicySetSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.all_applications, other.all_applications);
        crate::merge_strategies::list::atomic(&mut self.firewall_policy_references, other.firewall_policy_references);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.global_vrouter_config_reference, other.global_vrouter_config_reference);
        crate::DeepMerge::merge_from(&mut self.k8smode, other.k8smode);
        crate::merge_strategies::list::atomic(&mut self.tag_references, other.tag_references);
    }
}

impl<'de> crate::serde::Deserialize<'de> for ApplicationPolicySetSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_all_applications => value_all_applications = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_firewall_policy_references => value_firewall_policy_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_global_vrouter_config_reference => value_global_vrouter_config_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_k8smode => value_k8smode = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for ApplicationPolicySetSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.all_applications {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "allApplications", value)?;
        }
        if let Some(value) = &self.firewall_policy_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "firewallPolicyReferences", value)?;
        }
        ...
        if let Some(value) = &self.global_vrouter_config_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "globalVrouterConfigReference", value)?;
        }
