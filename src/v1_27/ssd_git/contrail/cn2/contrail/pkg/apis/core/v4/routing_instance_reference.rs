// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.RoutingInstanceReference

/// RoutingInstanceReference contains a RoutingInstance reference and an Attributes instance defining a policy forwarding rule.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct RoutingInstanceReference {
    /// API version of the referent.
    pub api_version: Option<String>,

    /// Attributes contains a policy forwarding rule which specifies the traffic direction (ingress, egress or both) for the routes to an optimal gateway.
    pub attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::PolicyBasedForwardingRule>,
...
impl crate::DeepMerge for RoutingInstanceReference {
...
impl<'de> crate::serde::Deserialize<'de> for RoutingInstanceReference {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("RoutingInstanceReference")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_api_version: Option<String> = None;
                let mut value_attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::PolicyBasedForwardingRule> = None;
...
impl crate::serde::Serialize for RoutingInstanceReference {
...
impl crate::schemars::JsonSchema for RoutingInstanceReference {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.RoutingInstanceReference".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("RoutingInstanceReference contains a RoutingInstance reference and an Attributes instance defining a policy forwarding rule.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "attributes".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::PolicyBasedForwardingRule>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Attributes contains a policy forwarding rule which specifies the traffic direction (ingress, egress or both) for the routes to an optimal gateway.".to_owned()),
                                ..Default::default()
                            }));
