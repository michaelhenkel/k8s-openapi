...
impl crate::DeepMerge for VirtualNetworkSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.export_route_target_list, other.export_route_target_list);
        crate::DeepMerge::merge_from(&mut self.fabric_forwarding, other.fabric_forwarding);
        crate::DeepMerge::merge_from(&mut self.fabric_snat, other.fabric_snat);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::merge_strategies::list::atomic(&mut self.import_route_target_list, other.import_route_target_list);
        crate::DeepMerge::merge_from(&mut self.is_provider_network, other.is_provider_network);
        crate::DeepMerge::merge_from(&mut self.pod_network, other.pod_network);
        crate::DeepMerge::merge_from(&mut self.provider_network_reference, other.provider_network_reference);
        crate::merge_strategies::list::atomic(&mut self.route_table_references, other.route_table_references);
        crate::merge_strategies::list::atomic(&mut self.route_target_list, other.route_target_list);
        crate::DeepMerge::merge_from(&mut self.v4_subnet_reference, other.v4_subnet_reference);
        crate::DeepMerge::merge_from(&mut self.v6_subnet_reference, other.v6_subnet_reference);
        crate::DeepMerge::merge_from(&mut self.virtual_network_network_id, other.virtual_network_network_id);
        crate::DeepMerge::merge_from(&mut self.virtual_network_properties, other.virtual_network_properties);
        crate::DeepMerge::merge_from(&mut self.vlan_id, other.vlan_id);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualNetworkSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_export_route_target_list => value_export_route_target_list = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fabric_forwarding => value_fabric_forwarding = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fabric_snat => value_fabric_snat = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_import_route_target_list => value_import_route_target_list = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_is_provider_network => value_is_provider_network = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_pod_network => value_pod_network = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_provider_network_reference => value_provider_network_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_route_table_references => value_route_table_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_route_target_list => value_route_target_list = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_v4_subnet_reference => value_v4_subnet_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_v6_subnet_reference => value_v6_subnet_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_network_network_id => value_virtual_network_network_id = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_network_properties => value_virtual_network_properties = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_vlan_id => value_vlan_id = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualNetworkSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.export_route_target_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "exportRouteTargetList", value)?;
        }
        if let Some(value) = &self.fabric_forwarding {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "fabricForwarding", value)?;
        }
        if let Some(value) = &self.fabric_snat {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "fabricSNAT", value)?;
        }
        ...
        if let Some(value) = &self.import_route_target_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "importRouteTargetList", value)?;
        }
        if let Some(value) = &self.is_provider_network {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "isProviderNetwork", value)?;
        }
        if let Some(value) = &self.pod_network {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "podNetwork", value)?;
        }
        if let Some(value) = &self.provider_network_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "providerNetworkReference", value)?;
        }
        if let Some(value) = &self.route_table_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routeTableReferences", value)?;
        }
        if let Some(value) = &self.route_target_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routeTargetList", value)?;
        }
        if let Some(value) = &self.v4_subnet_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "v4SubnetReference", value)?;
        }
        if let Some(value) = &self.v6_subnet_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "v6SubnetReference", value)?;
        }
        if let Some(value) = &self.virtual_network_network_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualNetworkNetworkId", value)?;
        }
        if let Some(value) = &self.virtual_network_properties {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualNetworkProperties", value)?;
        }
        if let Some(value) = &self.vlan_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vlanID", value)?;
        }
