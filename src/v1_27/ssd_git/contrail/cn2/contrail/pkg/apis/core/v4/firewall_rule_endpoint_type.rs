...
impl crate::DeepMerge for FirewallRuleEndpointType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.address_group, other.address_group);
        crate::DeepMerge::merge_from(&mut self.any, other.any);
        crate::merge_strategies::list::atomic(&mut self.match_expr, other.match_expr);
        crate::merge_strategies::list::atomic(&mut self.match_expr_list, other.match_expr_list);
        crate::DeepMerge::merge_from(&mut self.subnet, other.subnet);
        crate::merge_strategies::list::atomic(&mut self.tag_ids, other.tag_ids);
        crate::merge_strategies::list::atomic(&mut self.tags, other.tags);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallRuleEndpointType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_address_group => value_address_group = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_any => value_any = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_match_expr => value_match_expr = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_match_expr_list => value_match_expr_list = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_subnet => value_subnet = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_tag_ids => value_tag_ids = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_tags => value_tags = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallRuleEndpointType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.address_group {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "addressGroup", value)?;
        }
        if let Some(value) = &self.any {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "any", value)?;
        }
        if let Some(value) = &self.match_expr {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "matchExpr", value)?;
        }
        if let Some(value) = &self.match_expr_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "matchExprList", value)?;
        }
        ...
        if let Some(value) = &self.tag_ids {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagIds", value)?;
        }
        if let Some(value) = &self.tags {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tags", value)?;
        }
