...
impl crate::DeepMerge for InterfaceRouteTableSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.interface_route_table_routes, other.interface_route_table_routes);
    }
}

impl<'de> crate::serde::Deserialize<'de> for InterfaceRouteTableSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_interface_route_table_routes => value_interface_route_table_routes = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for InterfaceRouteTableSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.interface_route_table_routes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "interfaceRouteTableRoutes", value)?;
        }
