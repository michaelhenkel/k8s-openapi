...
impl crate::DeepMerge for SecondaryActionList {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.mirror_to, other.mirror_to);
    }
}

impl<'de> crate::serde::Deserialize<'de> for SecondaryActionList {
...
impl crate::serde::Serialize for SecondaryActionList {
