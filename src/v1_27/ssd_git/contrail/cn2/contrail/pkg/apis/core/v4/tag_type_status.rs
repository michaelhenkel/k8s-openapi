...
impl crate::DeepMerge for TagTypeStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.tag_type_id, other.tag_type_id);
    }
}

impl<'de> crate::serde::Deserialize<'de> for TagTypeStatus {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_tag_type_id => value_tag_type_id = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for TagTypeStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.tag_type_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagTypeId", value)?;
        }
