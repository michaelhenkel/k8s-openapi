...
impl crate::DeepMerge for FirewallMirrorActionType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.analyzer_ip_address, other.analyzer_ip_address);
        crate::DeepMerge::merge_from(&mut self.analyzer_mac_address, other.analyzer_mac_address);
        crate::DeepMerge::merge_from(&mut self.analyzer_name, other.analyzer_name);
        crate::DeepMerge::merge_from(&mut self.encapsulation, other.encapsulation);
        crate::DeepMerge::merge_from(&mut self.juniper_header, other.juniper_header);
        crate::DeepMerge::merge_from(&mut self.nh_mode, other.nh_mode);
        crate::DeepMerge::merge_from(&mut self.nic_assisted_mirroring, other.nic_assisted_mirroring);
        crate::DeepMerge::merge_from(&mut self.nic_assisted_mirroring_vlan, other.nic_assisted_mirroring_vlan);
        crate::DeepMerge::merge_from(&mut self.routing_instance, other.routing_instance);
        crate::DeepMerge::merge_from(&mut self.static_nh_header, other.static_nh_header);
        crate::DeepMerge::merge_from(&mut self.udp_port, other.udp_port);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallMirrorActionType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_analyzer_ip_address => value_analyzer_ip_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_analyzer_mac_address => value_analyzer_mac_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_analyzer_name => value_analyzer_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_encapsulation => value_encapsulation = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_juniper_header => value_juniper_header = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_nh_mode => value_nh_mode = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_nic_assisted_mirroring => value_nic_assisted_mirroring = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_nic_assisted_mirroring_vlan => value_nic_assisted_mirroring_vlan = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_routing_instance => value_routing_instance = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_static_nh_header => value_static_nh_header = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_udp_port => value_udp_port = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallMirrorActionType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.analyzer_ip_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "analyzerIPAddress", value)?;
        }
        if let Some(value) = &self.analyzer_mac_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "analyzerMacAddress", value)?;
        }
        if let Some(value) = &self.analyzer_name {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "analyzerName", value)?;
        }
        if let Some(value) = &self.encapsulation {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "encapsulation", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "juniperHeader", &self.juniper_header)?;
        if let Some(value) = &self.nh_mode {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nhMode", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nicAssistedMirroring", &self.nic_assisted_mirroring)?;
        if let Some(value) = &self.nic_assisted_mirroring_vlan {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "nicAssistedMirroringVlan", value)?;
        }
        if let Some(value) = &self.routing_instance {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routingInstance", value)?;
        }
        if let Some(value) = &self.static_nh_header {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "staticNhHeader", value)?;
        }
        if let Some(value) = &self.udp_port {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "udpPort", value)?;
        }
