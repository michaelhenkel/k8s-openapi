...
impl crate::DeepMerge for AuthenticationData {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.key_items, other.key_items);
        crate::DeepMerge::merge_from(&mut self.key_type, other.key_type);
    }
}

impl<'de> crate::serde::Deserialize<'de> for AuthenticationData {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_key_items => value_key_items = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for AuthenticationData {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.key_items {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "keyItems", value)?;
        }
        if let Some(value) = &self.key_type {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "keyType", value)?;
        }
