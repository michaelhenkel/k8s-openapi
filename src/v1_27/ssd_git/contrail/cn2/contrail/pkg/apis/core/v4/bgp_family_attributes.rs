...
impl crate::DeepMerge for BGPFamilyAttributes {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.address_family, other.address_family);
        crate::merge_strategies::list::atomic(&mut self.default_tunnel_encap, other.default_tunnel_encap);
        crate::DeepMerge::merge_from(&mut self.loop_count, other.loop_count);
        crate::DeepMerge::merge_from(&mut self.prefix_limit, other.prefix_limit);
    }
}

impl<'de> crate::serde::Deserialize<'de> for BGPFamilyAttributes {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_address_family => value_address_family = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_default_tunnel_encap => value_default_tunnel_encap = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_loop_count => value_loop_count = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_prefix_limit => value_prefix_limit = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for BGPFamilyAttributes {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.address_family {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "addressFamily", value)?;
        }
        if let Some(value) = &self.default_tunnel_encap {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "defaultTunnelEncap", value)?;
        }
        ...
        if let Some(value) = &self.prefix_limit {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "prefixLimit", value)?;
        }
