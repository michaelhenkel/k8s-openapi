...
impl crate::DeepMerge for VirtualNetworkStatus {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.evpn_routing_virtual_network_references, other.evpn_routing_virtual_network_references);
...
impl<'de> crate::serde::Deserialize<'de> for VirtualNetworkStatus {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_evpn_routing_virtual_network_references => value_evpn_routing_virtual_network_references = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualNetworkStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.evpn_routing_virtual_network_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "evpnRoutingVirtualNetworkReferences", value)?;
        }
