...
impl crate::DeepMerge for VirtualMachineInterfaceProperties {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.sub_interface_vlan_tag, other.sub_interface_vlan_tag);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualMachineInterfaceProperties {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_sub_interface_vlan_tag => value_sub_interface_vlan_tag = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualMachineInterfaceProperties {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.sub_interface_vlan_tag {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "subInterfaceVlanTag", value)?;
        }
