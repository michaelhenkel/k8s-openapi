...
impl crate::DeepMerge for VirtualMachineInterfaceStatus {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.bgp_router_reference, other.bgp_router_reference);
        crate::merge_strategies::list::atomic(&mut self.interface_route_table_references, other.interface_route_table_references);
        crate::DeepMerge::merge_from(&mut self.observation, other.observation);
        crate::merge_strategies::list::atomic(&mut self.routing_instance_references, other.routing_instance_references);
        crate::merge_strategies::list::atomic(&mut self.service_health_check_references, other.service_health_check_references);
        crate::DeepMerge::merge_from(&mut self.state, other.state);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualMachineInterfaceStatus {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_bgp_router_reference => value_bgp_router_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_interface_route_table_references => value_interface_route_table_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_observation => value_observation = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_routing_instance_references => value_routing_instance_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_service_health_check_references => value_service_health_check_references = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualMachineInterfaceStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.bgp_router_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "bgpRouterReference", value)?;
        }
        if let Some(value) = &self.interface_route_table_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "interfaceRouteTableReferences", value)?;
        }
        ...
        if let Some(value) = &self.routing_instance_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routingInstanceReferences", value)?;
        }
        if let Some(value) = &self.service_health_check_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serviceHealthCheckReferences", value)?;
        }
