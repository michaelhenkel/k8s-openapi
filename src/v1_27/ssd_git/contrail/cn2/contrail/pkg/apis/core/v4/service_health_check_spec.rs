...
impl crate::DeepMerge for ServiceHealthCheckSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.service_health_check_properties, other.service_health_check_properties);
    }
}

impl<'de> crate::serde::Deserialize<'de> for ServiceHealthCheckSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_service_health_check_properties => value_service_health_check_properties = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for ServiceHealthCheckSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serviceHealthCheckProperties", &self.service_health_check_properties)?;
