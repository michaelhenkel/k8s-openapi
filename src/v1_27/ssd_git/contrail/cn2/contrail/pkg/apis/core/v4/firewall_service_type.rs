...
impl crate::DeepMerge for FirewallServiceType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.dst_ports, other.dst_ports);
        crate::DeepMerge::merge_from(&mut self.protocol, other.protocol);
        crate::DeepMerge::merge_from(&mut self.protocol_id, other.protocol_id);
        crate::DeepMerge::merge_from(&mut self.src_ports, other.src_ports);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallServiceType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_dst_ports => value_dst_ports = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_protocol => value_protocol = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_protocol_id => value_protocol_id = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_src_ports => value_src_ports = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallServiceType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.dst_ports {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "dstPorts", value)?;
        }
        ...
        if let Some(value) = &self.protocol_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "protocolId", value)?;
        }
        if let Some(value) = &self.src_ports {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "srcPorts", value)?;
        }
