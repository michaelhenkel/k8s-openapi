// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.TagTypeSpec
...
impl crate::DeepMerge for TagTypeSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
    }
}

impl<'de> crate::serde::Deserialize<'de> for TagTypeSpec {
...
impl crate::serde::Serialize for TagTypeSpec {
...
impl crate::schemars::JsonSchema for TagTypeSpec {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.TagTypeSpec".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("TagTypeSpec defines the desired state of TagType".to_owned()),
                ..Default::default()
            })),
