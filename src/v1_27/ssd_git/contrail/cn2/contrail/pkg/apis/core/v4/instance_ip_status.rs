// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.InstanceIPStatus
...
impl crate::DeepMerge for InstanceIPStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.subnet_reference, other.subnet_reference);
    }
}

impl<'de> crate::serde::Deserialize<'de> for InstanceIPStatus {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_subnet_reference => value_subnet_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for InstanceIPStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.subnet_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "subnetReference", value)?;
        }
...
impl crate::schemars::JsonSchema for InstanceIPStatus {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.InstanceIPStatus".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("InstanceIPStatus defines the observed state of the InstanceIP.".to_owned()),
                ..Default::default()
            })),
                    ...
                    (
                        "subnetReference".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("SubnetReference refers to the Subnet this InstanceIP belongs to.".to_owned()),
                                ..Default::default()
                            }));
