...
impl crate::DeepMerge for PortRange {
...
impl<'de> crate::serde::Deserialize<'de> for PortRange {
...
impl crate::serde::Serialize for PortRange {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            "PortRange",
            2,
        )?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "endPort", &self.end_port)?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "startPort", &self.start_port)?;
