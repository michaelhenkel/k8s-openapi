// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.GlobalContrailSecurityPolicyStatus
...
impl crate::DeepMerge for GlobalContrailSecurityPolicyStatus {
...
impl<'de> crate::serde::Deserialize<'de> for GlobalContrailSecurityPolicyStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("GlobalContrailSecurityPolicyStatus")
            }
        ...
        deserializer.deserialize_struct(
            "GlobalContrailSecurityPolicyStatus",
            &[
                "observation",
                "state",
            ],
...
impl crate::serde::Serialize for GlobalContrailSecurityPolicyStatus {
...
impl crate::schemars::JsonSchema for GlobalContrailSecurityPolicyStatus {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.GlobalContrailSecurityPolicyStatus".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("GlobalContrailSecurityPolicySpec defines the observed state of GlobalContrailSecurityPolicy.".to_owned()),
                ..Default::default()
            })),
