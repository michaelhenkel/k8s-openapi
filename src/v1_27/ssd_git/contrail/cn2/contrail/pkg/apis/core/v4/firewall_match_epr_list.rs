...
impl crate::DeepMerge for FirewallMatchEprList {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.expr_list, other.expr_list);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallMatchEprList {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_expr_list => value_expr_list = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallMatchEprList {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.expr_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "exprList", value)?;
        }
