...
impl crate::DeepMerge for FirewallRuleSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.action_list, other.action_list);
        crate::DeepMerge::merge_from(&mut self.address_group_reference, other.address_group_reference);
        crate::DeepMerge::merge_from(&mut self.direction, other.direction);
        crate::DeepMerge::merge_from(&mut self.endpoint1, other.endpoint1);
        crate::DeepMerge::merge_from(&mut self.endpoint2, other.endpoint2);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.k8s_mode, other.k8s_mode);
        crate::merge_strategies::list::atomic(&mut self.match_tags, other.match_tags);
        crate::merge_strategies::list::atomic(&mut self.match_tags_types, other.match_tags_types);
        crate::DeepMerge::merge_from(&mut self.service, other.service);
        crate::DeepMerge::merge_from(&mut self.service_group_reference, other.service_group_reference);
        crate::merge_strategies::list::atomic(&mut self.tag_references, other.tag_references);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallRuleSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_action_list => value_action_list = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_address_group_reference => value_address_group_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_direction => value_direction = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_endpoint1 => value_endpoint1 = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_endpoint2 => value_endpoint2 = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_k8s_mode => value_k8s_mode = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_match_tags => value_match_tags = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_match_tags_types => value_match_tags_types = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_service => value_service = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_service_group_reference => value_service_group_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallRuleSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.action_list {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "actionList", value)?;
        }
        if let Some(value) = &self.address_group_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "addressGroupReference", value)?;
        }
        ...
        if let Some(value) = &self.endpoint1 {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "endpoint1", value)?;
        }
        if let Some(value) = &self.endpoint2 {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "endpoint2", value)?;
        }
        ...
        if let Some(value) = &self.k8s_mode {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "k8sMode", value)?;
        }
        if let Some(value) = &self.match_tags {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "matchTags", value)?;
        }
        if let Some(value) = &self.match_tags_types {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "matchTagsTypes", value)?;
        }
        ...
        if let Some(value) = &self.service_group_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serviceGroupReference", value)?;
        }
