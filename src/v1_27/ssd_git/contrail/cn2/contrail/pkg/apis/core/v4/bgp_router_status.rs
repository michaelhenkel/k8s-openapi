// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.BGPRouterStatus
...
impl crate::DeepMerge for BGPRouterStatus {
...
impl<'de> crate::serde::Deserialize<'de> for BGPRouterStatus {
...
impl crate::serde::Serialize for BGPRouterStatus {
...
impl crate::schemars::JsonSchema for BGPRouterStatus {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.BGPRouterStatus".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("BGPRouterStatus defines the observed state of BGPRouter".to_owned()),
                ..Default::default()
            })),
