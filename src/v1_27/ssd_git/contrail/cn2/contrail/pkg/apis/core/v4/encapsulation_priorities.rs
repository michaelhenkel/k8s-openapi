...
impl crate::DeepMerge for EncapsulationPriorities {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.encapsulation, other.encapsulation);
    }
}

impl<'de> crate::serde::Deserialize<'de> for EncapsulationPriorities {
...
impl crate::serde::Serialize for EncapsulationPriorities {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        let mut state = serializer.serialize_struct(
            "EncapsulationPriorities",
            1,
        )?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "encapsulation", &self.encapsulation)?;
