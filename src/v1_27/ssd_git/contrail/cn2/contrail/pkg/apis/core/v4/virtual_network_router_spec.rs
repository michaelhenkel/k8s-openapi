...
pub struct VirtualNetworkRouterSpec {
    ...
    pub virtual_network_selector: crate::apimachinery::pkg::apis::meta::v1::LabelSelector,
}

impl crate::DeepMerge for VirtualNetworkRouterSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.import, other.import);
        crate::DeepMerge::merge_from(&mut self.l3vxlan_network_identifier, other.l3vxlan_network_identifier);
        crate::DeepMerge::merge_from(&mut self.route_target, other.route_target);
        crate::DeepMerge::merge_from(&mut self.routing_type, other.routing_type);
        crate::DeepMerge::merge_from(&mut self.type_, other.type_);
        crate::DeepMerge::merge_from(&mut self.virtual_network_selector, other.virtual_network_selector);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualNetworkRouterSpec {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_virtual_network_selector: Option<crate::apimachinery::pkg::apis::meta::v1::LabelSelector> = None;

                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_import => value_import = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_l3vxlan_network_identifier => value_l3vxlan_network_identifier = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_route_target => value_route_target = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_routing_type => value_routing_type = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_type_ => value_type_ = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_network_selector => value_virtual_network_selector = Some(crate::serde::de::MapAccess::next_value(&mut map)?),
                ...
                Ok(VirtualNetworkRouterSpec {
                    ...
                    virtual_network_selector: value_virtual_network_selector.ok_or_else(|| crate::serde::de::Error::missing_field("virtualNetworkSelector"))?,
                })
            }
        }
...
impl crate::serde::Serialize for VirtualNetworkRouterSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.import {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "import", value)?;
        }
        ...
        if let Some(value) = &self.route_target {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routeTarget", value)?;
        }
        if let Some(value) = &self.routing_type {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routingType", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "type", &self.type_)?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualNetworkSelector", &self.virtual_network_selector)?;
