...
pub struct BGPAsAServiceSpec {
    ...
    pub virtual_machine_interfaces_selector: Option<Vec<crate::apimachinery::pkg::apis::meta::v1::LabelSelector>>,
}

impl crate::DeepMerge for BGPAsAServiceSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.autonomous_system, other.autonomous_system);
        crate::DeepMerge::merge_from(&mut self.bgp_as_a_service_session_attributes, other.bgp_as_a_service_session_attributes);
        ...
        crate::DeepMerge::merge_from(&mut self.ipv4_mapped_i_pv6_next_hop, other.ipv4_mapped_i_pv6_next_hop);
        crate::DeepMerge::merge_from(&mut self.service_health_check_reference, other.service_health_check_reference);
        crate::DeepMerge::merge_from(&mut self.shared, other.shared);
        crate::DeepMerge::merge_from(&mut self.suppress_route_advertisement, other.suppress_route_advertisement);
        ...
        crate::merge_strategies::list::atomic(&mut self.virtual_machine_interfaces_selector, other.virtual_machine_interfaces_selector);
    }
}

impl<'de> crate::serde::Deserialize<'de> for BGPAsAServiceSpec {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_virtual_machine_interfaces_selector: Option<Vec<crate::apimachinery::pkg::apis::meta::v1::LabelSelector>> = None;

                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_autonomous_system => value_autonomous_system = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_bgp_as_a_service_session_attributes => value_bgp_as_a_service_session_attributes = crate::serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_ipv4_mapped_i_pv6_next_hop => value_ipv4_mapped_i_pv6_next_hop = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_service_health_check_reference => value_service_health_check_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_shared => value_shared = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_suppress_route_advertisement => value_suppress_route_advertisement = crate::serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_virtual_machine_interfaces_selector => value_virtual_machine_interfaces_selector = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for BGPAsAServiceSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.bgp_as_a_service_session_attributes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "bgpAsAServiceSessionAttributes", value)?;
        }
        ...
        if let Some(value) = &self.ipv4_mapped_i_pv6_next_hop {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ipv4MappedIPv6NextHop", value)?;
        }
        if let Some(value) = &self.service_health_check_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serviceHealthCheckReference", value)?;
        }
        if let Some(value) = &self.shared {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "shared", value)?;
        }
        if let Some(value) = &self.suppress_route_advertisement {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "suppressRouteAdvertisement", value)?;
        }
        ...
        if let Some(value) = &self.virtual_machine_interfaces_selector {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualMachineInterfacesSelector", value)?;
        }
