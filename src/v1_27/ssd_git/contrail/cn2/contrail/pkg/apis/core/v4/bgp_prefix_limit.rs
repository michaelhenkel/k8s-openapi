...
impl crate::DeepMerge for BGPPrefixLimit {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.idle_timeout, other.idle_timeout);
        crate::DeepMerge::merge_from(&mut self.maximum, other.maximum);
    }
}

impl<'de> crate::serde::Deserialize<'de> for BGPPrefixLimit {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_idle_timeout => value_idle_timeout = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for BGPPrefixLimit {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.idle_timeout {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "idleTimeout", value)?;
        }
