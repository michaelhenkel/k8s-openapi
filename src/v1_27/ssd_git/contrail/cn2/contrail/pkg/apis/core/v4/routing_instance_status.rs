...
impl crate::DeepMerge for RoutingInstanceStatus {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.default_route_target_reference, other.default_route_target_reference);
        crate::DeepMerge::merge_from(&mut self.is_default, other.is_default);
        crate::DeepMerge::merge_from(&mut self.observation, other.observation);
        crate::DeepMerge::merge_from(&mut self.routing_instance_fabric_snat, other.routing_instance_fabric_snat);
        crate::DeepMerge::merge_from(&mut self.state, other.state);
        crate::merge_strategies::map::granular(&mut self.virtual_network_router_route_target_references, other.virtual_network_router_route_target_references, |current_item, other_item| {
            crate::DeepMerge::merge_from(current_item, other_item);
        });
    }
}

impl<'de> crate::serde::Deserialize<'de> for RoutingInstanceStatus {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_default_route_target_reference => value_default_route_target_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_is_default => value_is_default = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_observation => value_observation = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_routing_instance_fabric_snat => value_routing_instance_fabric_snat = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_state => value_state = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_network_router_route_target_references => value_virtual_network_router_route_target_references = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for RoutingInstanceStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.default_route_target_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "defaultRouteTargetReference", value)?;
        }
        if let Some(value) = &self.is_default {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "isDefault", value)?;
        }
        ...
        if let Some(value) = &self.routing_instance_fabric_snat {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routingInstanceFabricSNAT", value)?;
        }
        ...
        if let Some(value) = &self.virtual_network_router_route_target_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualNetworkRouterRouteTargetReferences", value)?;
        }
