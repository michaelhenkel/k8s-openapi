...
impl crate::DeepMerge for ImportVirtualNetworkRouter {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.virtual_network_routers, other.virtual_network_routers);
    }
}

impl<'de> crate::serde::Deserialize<'de> for ImportVirtualNetworkRouter {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_virtual_network_routers => value_virtual_network_routers = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for ImportVirtualNetworkRouter {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.virtual_network_routers {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualNetworkRouters", value)?;
        }
