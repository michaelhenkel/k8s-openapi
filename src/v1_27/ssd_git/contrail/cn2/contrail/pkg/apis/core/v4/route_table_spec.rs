...
impl crate::DeepMerge for RouteTableSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.routes, other.routes);
    }
}

impl<'de> crate::serde::Deserialize<'de> for RouteTableSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_routes => value_routes = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for RouteTableSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.routes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routes", value)?;
        }
