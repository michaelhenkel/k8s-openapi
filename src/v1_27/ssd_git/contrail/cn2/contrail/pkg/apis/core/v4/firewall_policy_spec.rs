...
impl crate::DeepMerge for FirewallPolicySpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.firewall_rule_references, other.firewall_rule_references);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.vmi_selector, other.vmi_selector);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallPolicySpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_firewall_rule_references => value_firewall_rule_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_vmi_selector => value_vmi_selector = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for FirewallPolicySpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.firewall_rule_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "firewallRuleReferences", value)?;
        }
        ...
        if let Some(value) = &self.vmi_selector {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vmiSelector", value)?;
        }
