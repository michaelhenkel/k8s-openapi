// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.SubnetReference

/// SubnetReference contains a Subnet reference and a BGPSessionIPAttributes instance defining the BGPaaSPrimaryIP and BGPaaSSecondaryIP addresses.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct SubnetReference {
    /// API version of the referent.
    pub api_version: Option<String>,

    pub attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::BGPSessionIPAttributes>,
...
impl crate::DeepMerge for SubnetReference {
...
impl<'de> crate::serde::Deserialize<'de> for SubnetReference {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("SubnetReference")
            }

            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_api_version: Option<String> = None;
                let mut value_attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::BGPSessionIPAttributes> = None;
...
impl crate::serde::Serialize for SubnetReference {
...
impl crate::schemars::JsonSchema for SubnetReference {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.SubnetReference".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("SubnetReference contains a Subnet reference and a BGPSessionIPAttributes instance defining the BGPaaSPrimaryIP and BGPaaSSecondaryIP addresses.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "attributes".to_owned(),
                        __gen.subschema_for::<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::BGPSessionIPAttributes>(),
                    ),
                    (
                        "fieldPath".to_owned(),
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
