...
impl crate::DeepMerge for SubnetSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.default_gateway, other.default_gateway);
        crate::DeepMerge::merge_from(&mut self.disable_bg_paa_sip_auto_allocation, other.disable_bg_paa_sip_auto_allocation);
        crate::merge_strategies::list::atomic(&mut self.dns_nameservers, other.dns_nameservers);
        crate::DeepMerge::merge_from(&mut self.enable_dhcp, other.enable_dhcp);
...
impl<'de> crate::serde::Deserialize<'de> for SubnetSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_default_gateway => value_default_gateway = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_disable_bg_paa_sip_auto_allocation => value_disable_bg_paa_sip_auto_allocation = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_dns_nameservers => value_dns_nameservers = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_enable_dhcp => value_enable_dhcp = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for SubnetSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.default_gateway {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "defaultGateway", value)?;
        }
        if let Some(value) = &self.disable_bg_paa_sip_auto_allocation {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "disableBGPaaSIPAutoAllocation", value)?;
        }
        if let Some(value) = &self.dns_nameservers {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "dnsNameservers", value)?;
        }
        if let Some(value) = &self.enable_dhcp {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "enableDhcp", value)?;
        }
