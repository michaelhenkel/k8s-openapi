...
impl crate::DeepMerge for CommunityAttributes {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.community_attribute, other.community_attribute);
    }
}

impl<'de> crate::serde::Deserialize<'de> for CommunityAttributes {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_community_attribute => value_community_attribute = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for CommunityAttributes {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.community_attribute {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "communityAttribute", value)?;
        }
