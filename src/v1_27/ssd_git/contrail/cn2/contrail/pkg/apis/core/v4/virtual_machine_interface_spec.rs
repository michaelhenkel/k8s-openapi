...
pub struct VirtualMachineInterfaceSpec {
    ...
    pub parent: Option<crate::api::core::v1::ObjectReference>,
...
impl crate::DeepMerge for VirtualMachineInterfaceSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.allowed_address_pairs, other.allowed_address_pairs);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.parent, other.parent);
        crate::DeepMerge::merge_from(&mut self.port_security_enabled, other.port_security_enabled);
        crate::DeepMerge::merge_from(&mut self.properties, other.properties);
        crate::merge_strategies::list::atomic(&mut self.tag_references, other.tag_references);
        crate::DeepMerge::merge_from(&mut self.virtual_machine_interface_disable_policy, other.virtual_machine_interface_disable_policy);
        crate::DeepMerge::merge_from(&mut self.virtual_machine_interface_mac_addresses, other.virtual_machine_interface_mac_addresses);
        crate::merge_strategies::list::atomic(&mut self.virtual_machine_interface_references, other.virtual_machine_interface_references);
        crate::merge_strategies::list::atomic(&mut self.virtual_machine_references, other.virtual_machine_references);
        crate::DeepMerge::merge_from(&mut self.virtual_network_reference, other.virtual_network_reference);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualMachineInterfaceSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_allowed_address_pairs => value_allowed_address_pairs = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_parent => value_parent = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_port_security_enabled => value_port_security_enabled = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_properties => value_properties = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_tag_references => value_tag_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_machine_interface_disable_policy => value_virtual_machine_interface_disable_policy = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_machine_interface_mac_addresses => value_virtual_machine_interface_mac_addresses = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_machine_interface_references => value_virtual_machine_interface_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_machine_references => value_virtual_machine_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_network_reference => value_virtual_network_reference = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualMachineInterfaceSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.allowed_address_pairs {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "allowedAddressPairs", value)?;
        }
        ...
        if let Some(value) = &self.parent {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "parent", value)?;
        }
        if let Some(value) = &self.port_security_enabled {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "portSecurityEnabled", value)?;
        }
        ...
        if let Some(value) = &self.tag_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "tagReferences", value)?;
        }
        if let Some(value) = &self.virtual_machine_interface_disable_policy {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualMachineInterfaceDisablePolicy", value)?;
        }
        if let Some(value) = &self.virtual_machine_interface_mac_addresses {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualMachineInterfaceMacAddresses", value)?;
        }
        if let Some(value) = &self.virtual_machine_interface_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualMachineInterfaceReferences", value)?;
        }
        if let Some(value) = &self.virtual_machine_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualMachineReferences", value)?;
        }
        if let Some(value) = &self.virtual_network_reference {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualNetworkReference", value)?;
        }
