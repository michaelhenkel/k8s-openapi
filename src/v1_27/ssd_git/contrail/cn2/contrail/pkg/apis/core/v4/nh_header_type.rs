...
impl crate::DeepMerge for NHHeaderType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.v_tep_destination_ip, other.v_tep_destination_ip);
        crate::DeepMerge::merge_from(&mut self.v_tep_destination_mac, other.v_tep_destination_mac);
        crate::DeepMerge::merge_from(&mut self.vxlan_id, other.vxlan_id);
    }
}

impl<'de> crate::serde::Deserialize<'de> for NHHeaderType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_v_tep_destination_ip => value_v_tep_destination_ip = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_v_tep_destination_mac => value_v_tep_destination_mac = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_vxlan_id => value_vxlan_id = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for NHHeaderType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.v_tep_destination_ip {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vTEPDestinationIP", value)?;
        }
        if let Some(value) = &self.v_tep_destination_mac {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vTEPDestinationMac", value)?;
        }
        if let Some(value) = &self.vxlan_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vxlanID", value)?;
        }
