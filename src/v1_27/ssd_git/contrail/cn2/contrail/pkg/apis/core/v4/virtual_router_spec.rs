...
impl crate::DeepMerge for VirtualRouterSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.virtual_router_dpdk_enabled, other.virtual_router_dpdk_enabled);
        crate::DeepMerge::merge_from(&mut self.virtual_router_ip_address, other.virtual_router_ip_address);
        crate::DeepMerge::merge_from(&mut self.virtual_router_type, other.virtual_router_type);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualRouterSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_virtual_router_dpdk_enabled => value_virtual_router_dpdk_enabled = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_router_ip_address => value_virtual_router_ip_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_virtual_router_type => value_virtual_router_type = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualRouterSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.virtual_router_dpdk_enabled {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualRouterDpdkEnabled", value)?;
        }
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualRouterIPAddress", &self.virtual_router_ip_address)?;
        if let Some(value) = &self.virtual_router_type {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "virtualRouterType", value)?;
        }
