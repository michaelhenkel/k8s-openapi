...
impl crate::DeepMerge for BGPRouterParameters {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.address, other.address);
        crate::DeepMerge::merge_from(&mut self.address_families, other.address_families);
        crate::DeepMerge::merge_from(&mut self.admin_down, other.admin_down);
        crate::DeepMerge::merge_from(&mut self.auth_data, other.auth_data);
        crate::DeepMerge::merge_from(&mut self.autonomous_system, other.autonomous_system);
        crate::DeepMerge::merge_from(&mut self.cluster_id, other.cluster_id);
        crate::DeepMerge::merge_from(&mut self.gateway_address, other.gateway_address);
        crate::DeepMerge::merge_from(&mut self.hold_time, other.hold_time);
        crate::DeepMerge::merge_from(&mut self.identifier, other.identifier);
        crate::DeepMerge::merge_from(&mut self.ipv6_gateway_address, other.ipv6_gateway_address);
        crate::DeepMerge::merge_from(&mut self.local_autonomous_system, other.local_autonomous_system);
        crate::DeepMerge::merge_from(&mut self.port, other.port);
        crate::DeepMerge::merge_from(&mut self.router_type, other.router_type);
        crate::DeepMerge::merge_from(&mut self.source_port, other.source_port);
        crate::DeepMerge::merge_from(&mut self.vendor, other.vendor);
    }
}

impl<'de> crate::serde::Deserialize<'de> for BGPRouterParameters {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_address_families => value_address_families = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_admin_down => value_admin_down = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_auth_data => value_auth_data = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_autonomous_system => value_autonomous_system = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_cluster_id => value_cluster_id = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_gateway_address => value_gateway_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_hold_time => value_hold_time = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_identifier => value_identifier = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ipv6_gateway_address => value_ipv6_gateway_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_local_autonomous_system => value_local_autonomous_system = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_port => value_port = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_router_type => value_router_type = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_source_port => value_source_port = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_vendor => value_vendor = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for BGPRouterParameters {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "address", value)?;
        }
        if let Some(value) = &self.address_families {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "addressFamilies", value)?;
        }
        if let Some(value) = &self.admin_down {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "adminDown", value)?;
        }
        if let Some(value) = &self.auth_data {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "authData", value)?;
        }
        if let Some(value) = &self.autonomous_system {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "autonomousSystem", value)?;
        }
        if let Some(value) = &self.cluster_id {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "clusterID", value)?;
        }
        if let Some(value) = &self.gateway_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "gatewayAddress", value)?;
        }
        if let Some(value) = &self.hold_time {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "holdTime", value)?;
        }
        if let Some(value) = &self.identifier {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "identifier", value)?;
        }
        if let Some(value) = &self.ipv6_gateway_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ipv6GatewayAddress", value)?;
        }
        if let Some(value) = &self.local_autonomous_system {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "localAutonomousSystem", value)?;
        }
        if let Some(value) = &self.port {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "port", value)?;
        }
        if let Some(value) = &self.router_type {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routerType", value)?;
        }
        if let Some(value) = &self.source_port {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "sourcePort", value)?;
        }
        if let Some(value) = &self.vendor {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vendor", value)?;
        }
