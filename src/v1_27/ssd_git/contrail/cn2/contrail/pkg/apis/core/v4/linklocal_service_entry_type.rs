...
impl crate::DeepMerge for LinklocalServiceEntryType {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.ip_fabric_dns_service_name, other.ip_fabric_dns_service_name);
        crate::merge_strategies::list::atomic(&mut self.ip_fabric_service_ip, other.ip_fabric_service_ip);
        crate::DeepMerge::merge_from(&mut self.ip_fabric_service_port, other.ip_fabric_service_port);
        crate::DeepMerge::merge_from(&mut self.linklocal_service_ip, other.linklocal_service_ip);
        crate::DeepMerge::merge_from(&mut self.linklocal_service_name, other.linklocal_service_name);
        crate::DeepMerge::merge_from(&mut self.linklocal_service_port, other.linklocal_service_port);
    }
}

impl<'de> crate::serde::Deserialize<'de> for LinklocalServiceEntryType {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_ip_fabric_dns_service_name => value_ip_fabric_dns_service_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ip_fabric_service_ip => value_ip_fabric_service_ip = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ip_fabric_service_port => value_ip_fabric_service_port = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_linklocal_service_ip => value_linklocal_service_ip = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_linklocal_service_name => value_linklocal_service_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_linklocal_service_port => value_linklocal_service_port = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for LinklocalServiceEntryType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.ip_fabric_dns_service_name {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ipFabricDNSServiceName", value)?;
        }
        if let Some(value) = &self.ip_fabric_service_ip {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ipFabricServiceIP", value)?;
        }
        if let Some(value) = &self.ip_fabric_service_port {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ipFabricServicePort", value)?;
        }
        if let Some(value) = &self.linklocal_service_ip {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "linklocalServiceIP", value)?;
        }
        if let Some(value) = &self.linklocal_service_name {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "linklocalServiceName", value)?;
        }
        if let Some(value) = &self.linklocal_service_port {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "linklocalServicePort", value)?;
        }
