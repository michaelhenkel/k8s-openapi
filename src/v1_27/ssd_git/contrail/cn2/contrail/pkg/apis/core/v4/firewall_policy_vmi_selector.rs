...
impl crate::DeepMerge for FirewallPolicyVMISelector {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.match_expr_list, other.match_expr_list);
    }
}

impl<'de> crate::serde::Deserialize<'de> for FirewallPolicyVMISelector {
...
impl crate::serde::Serialize for FirewallPolicyVMISelector {
