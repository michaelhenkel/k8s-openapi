// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.InterfaceRouteTableStatus
...
impl crate::DeepMerge for InterfaceRouteTableStatus {
...
impl<'de> crate::serde::Deserialize<'de> for InterfaceRouteTableStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("InterfaceRouteTableStatus")
            }
...
impl crate::serde::Serialize for InterfaceRouteTableStatus {
...
impl crate::schemars::JsonSchema for InterfaceRouteTableStatus {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.InterfaceRouteTableStatus".to_owned()
    }
