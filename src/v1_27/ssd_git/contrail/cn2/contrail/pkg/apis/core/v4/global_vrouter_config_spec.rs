...
impl crate::DeepMerge for GlobalVrouterConfigSpec {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.encapsulation_priorities, other.encapsulation_priorities);
        crate::DeepMerge::merge_from(&mut self.flow_export_rate, other.flow_export_rate);
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.linklocal_services, other.linklocal_services);
        crate::DeepMerge::merge_from(&mut self.parent, other.parent);
        crate::DeepMerge::merge_from(&mut self.port_translation_pools, other.port_translation_pools);
    }
}

impl<'de> crate::serde::Deserialize<'de> for GlobalVrouterConfigSpec {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_encapsulation_priorities => value_encapsulation_priorities = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_flow_export_rate => value_flow_export_rate = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_fq_name => value_fq_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_linklocal_services => value_linklocal_services = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_parent => value_parent = Some(crate::serde::de::MapAccess::next_value(&mut map)?),
                        Field::Key_port_translation_pools => value_port_translation_pools = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for GlobalVrouterConfigSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.encapsulation_priorities {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "encapsulationPriorities", value)?;
        }
        if let Some(value) = &self.flow_export_rate {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "flowExportRate", value)?;
        }
        ...
        if let Some(value) = &self.linklocal_services {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "linklocalServices", value)?;
        }
        ...
        if let Some(value) = &self.port_translation_pools {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "portTranslationPools", value)?;
        }
