// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.RouteTargetReference

/// RouteTargetReference contains a RouteTarget reference and the import/export mode in their attributes.
#[derive(Clone, Debug, Default, PartialEq)]
pub struct RouteTargetReference {
    /// API version of the referent.
    pub api_version: Option<String>,

    /// Attributes contains the ImportExport flag. When ImportExport is blank (the default), both import and export are supported. Setting ImportExport to "import" enables import-only mode. Setting it to "export" enables export-only mode.
    pub attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::RouteTargetReferenceAttributes>,
...
impl crate::DeepMerge for RouteTargetReference {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.api_version, other.api_version);
        crate::DeepMerge::merge_from(&mut self.attributes, other.attributes);
...
impl<'de> crate::serde::Deserialize<'de> for RouteTargetReference {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_attributes: Option<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::RouteTargetReferenceAttributes> = None;
...
impl crate::serde::Serialize for RouteTargetReference {
...
impl crate::schemars::JsonSchema for RouteTargetReference {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.RouteTargetReference".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("RouteTargetReference contains a RouteTarget reference and the import/export mode in their attributes.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "attributes".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::ssd_git::contrail::cn2::contrail::pkg::apis::core::v4::RouteTargetReferenceAttributes>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Attributes contains the ImportExport flag. When ImportExport is blank (the default), both import and export are supported. Setting ImportExport to \"import\" enables import-only mode. Setting it to \"export\" enables export-only mode.".to_owned()),
                                ..Default::default()
                            }));
