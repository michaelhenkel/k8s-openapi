// Generated from definition net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.FirewallRuleStatus
...
impl crate::DeepMerge for FirewallRuleStatus {
...
impl<'de> crate::serde::Deserialize<'de> for FirewallRuleStatus {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("FirewallRuleStatus")
            }
...
impl crate::serde::Serialize for FirewallRuleStatus {
...
impl crate::schemars::JsonSchema for FirewallRuleStatus {
    fn schema_name() -> String {
        "net.juniper.ssd-git.contrail.cn2.contrail.pkg.apis.core.v4.FirewallRuleStatus".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("FirewallRuleStatus defines the observed state of FirewallRule.".to_owned()),
                ..Default::default()
            })),
