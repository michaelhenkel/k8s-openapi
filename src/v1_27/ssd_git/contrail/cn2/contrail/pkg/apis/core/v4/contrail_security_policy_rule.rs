...
impl crate::DeepMerge for ContrailSecurityPolicyRule {
    fn merge_from(&mut self, other: Self) {
        crate::DeepMerge::merge_from(&mut self.dst_ep, other.dst_ep);
        ...
        crate::DeepMerge::merge_from(&mut self.src_ep, other.src_ep);
    }
}

impl<'de> crate::serde::Deserialize<'de> for ContrailSecurityPolicyRule {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_dst_ep => value_dst_ep = crate::serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_src_ep => value_src_ep = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for ContrailSecurityPolicyRule {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.dst_ep {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "dstEP", value)?;
        }
        ...
        if let Some(value) = &self.src_ep {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "srcEP", value)?;
        }
