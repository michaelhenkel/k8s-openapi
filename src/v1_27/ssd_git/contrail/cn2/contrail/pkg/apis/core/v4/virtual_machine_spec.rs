...
impl crate::DeepMerge for VirtualMachineSpec {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(&mut self.fq_name, other.fq_name);
        crate::DeepMerge::merge_from(&mut self.server_cluster_name, other.server_cluster_name);
        crate::DeepMerge::merge_from(&mut self.server_name, other.server_name);
        crate::DeepMerge::merge_from(&mut self.server_namespace, other.server_namespace);
        crate::DeepMerge::merge_from(&mut self.server_type, other.server_type);
    }
}

impl<'de> crate::serde::Deserialize<'de> for VirtualMachineSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_server_cluster_name => value_server_cluster_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_server_name => value_server_name = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_server_namespace => value_server_namespace = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_server_type => value_server_type = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for VirtualMachineSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serverClusterName", &self.server_cluster_name)?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serverName", &self.server_name)?;
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serverNamespace", &self.server_namespace)?;
        if let Some(value) = &self.server_type {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "serverType", value)?;
        }
