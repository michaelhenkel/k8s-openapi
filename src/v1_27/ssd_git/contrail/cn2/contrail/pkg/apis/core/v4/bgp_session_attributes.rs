...
impl crate::DeepMerge for BGPSessionAttributes {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.as_override, other.as_override);
        crate::DeepMerge::merge_from(&mut self.auth_data, other.auth_data);
        crate::DeepMerge::merge_from(&mut self.bgp_router, other.bgp_router);
        crate::merge_strategies::list::atomic(&mut self.family_attributes, other.family_attributes);
        ...
        crate::DeepMerge::merge_from(&mut self.loop_count, other.loop_count);
        crate::DeepMerge::merge_from(&mut self.passive, other.passive);
        crate::DeepMerge::merge_from(&mut self.private_as_action, other.private_as_action);
        crate::DeepMerge::merge_from(&mut self.route_origin_override, other.route_origin_override);
    }
}

impl<'de> crate::serde::Deserialize<'de> for BGPSessionAttributes {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_as_override => value_as_override = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_auth_data => value_auth_data = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_bgp_router => value_bgp_router = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_family_attributes => value_family_attributes = crate::serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_loop_count => value_loop_count = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_passive => value_passive = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_private_as_action => value_private_as_action = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_route_origin_override => value_route_origin_override = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for BGPSessionAttributes {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.as_override {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "asOverride", value)?;
        }
        ...
        if let Some(value) = &self.bgp_router {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "bgpRouter", value)?;
        }
        if let Some(value) = &self.family_attributes {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "familyAttributes", value)?;
        }
        ...
        if let Some(value) = &self.loop_count {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "loopCount", value)?;
        }
        if let Some(value) = &self.passive {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "passive", value)?;
        }
        if let Some(value) = &self.private_as_action {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "privateAsAction", value)?;
        }
        if let Some(value) = &self.route_origin_override {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "routeOriginOverride", value)?;
        }
