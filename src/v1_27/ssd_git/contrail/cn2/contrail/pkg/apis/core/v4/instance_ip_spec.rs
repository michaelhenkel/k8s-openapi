...
impl crate::DeepMerge for InstanceIPSpec {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::DeepMerge::merge_from(&mut self.instance_ip_address, other.instance_ip_address);
        crate::DeepMerge::merge_from(&mut self.instance_ip_family, other.instance_ip_family);
        crate::merge_strategies::list::atomic(&mut self.ip_range_keys, other.ip_range_keys);
...
impl<'de> crate::serde::Deserialize<'de> for InstanceIPSpec {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_instance_ip_address => value_instance_ip_address = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_instance_ip_family => value_instance_ip_family = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ip_range_keys => value_ip_range_keys = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for InstanceIPSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.cidr {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "cidr", value)?;
        }
        ...
        if let Some(value) = &self.instance_ip_address {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "instanceIPAddress", value)?;
        }
        if let Some(value) = &self.instance_ip_family {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "instanceIPFamily", value)?;
        }
        if let Some(value) = &self.ip_range_keys {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ipRangeKeys", value)?;
        }
