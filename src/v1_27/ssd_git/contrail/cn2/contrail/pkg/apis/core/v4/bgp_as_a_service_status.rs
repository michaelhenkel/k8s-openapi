...
impl crate::DeepMerge for BGPAsAServiceStatus {
    fn merge_from(&mut self, other: Self) {
        ...
        crate::merge_strategies::list::atomic(&mut self.subnet_references, other.subnet_references);
        crate::merge_strategies::list::atomic(&mut self.vmi_selector_references, other.vmi_selector_references);
    }
}

impl<'de> crate::serde::Deserialize<'de> for BGPAsAServiceStatus {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_subnet_references => value_subnet_references = crate::serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_vmi_selector_references => value_vmi_selector_references = crate::serde::de::MapAccess::next_value(&mut map)?,
...
impl crate::serde::Serialize for BGPAsAServiceStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        if let Some(value) = &self.subnet_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "subnetReferences", value)?;
        }
        if let Some(value) = &self.vmi_selector_references {
            crate::serde::ser::SerializeStruct::serialize_field(&mut state, "vmiSelectorReferences", value)?;
        }
